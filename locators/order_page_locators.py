...
class OrderPageLocators:
    ...
    OCTOBER_DATE_31 = (By.XPATH, "//div[@class='react-datepicker__day react-datepicker__day--031']")
    RENT_DAYS_2 = (By.XPATH, "//div[text()='двое суток']")
    SOKOLNIKI_METRO_STATION = (By.XPATH, "//div[text()='Сокольники']")
    OCTOBER_DATE_22 = (By.XPATH, "//div[@class='react-datepicker__day react-datepicker__day--022']")
